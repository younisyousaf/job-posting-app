...
"[project]/.next-internal/server/app/api/jobs/[jobId]/apply/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
var ms = ne((Hg, jc)=>{
    jc.exports = {
        ...
        dependencies: {
            ...
            "@prisma/prisma-schema-wasm": "6.10.0-43.aee10d5a411e4360c6d3445ce4810ca65adbf3e8",
            "@prisma/schema-engine-wasm": "6.10.0-43.aee10d5a411e4360c6d3445ce4810ca65adbf3e8",
 ...
 */ const config = {
    "generator": {
        ...
        "output": {
            "value": "D:\\prisma-starter\\job-posting-app\\app\\generated\\prisma",
            "fromEnvVar": null
        },
        "config": {
            "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "D:\\prisma-starter\\job-posting-app\\prisma\\schema.prisma",
        "isCustomOutput": true
    },
    "relativeEnvPaths": {
        "rootEnvPath": null,
    ...
    "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\n// Looking for ways to speed up your queries, or scale easily with your serverless or edge functions?\n// Try Prisma Accelerate: https://pris.ly/cli/accelerate-init\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../app/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Account {\n  id                String  @id @default(cuid())\n  userId            String\n  type              String\n  provider          String\n  providerAccountId String\n  refresh_token     String? @db.Text\n  access_token      String? @db.Text\n  expires_at        Int?\n  token_type        String?\n  scope             String?\n  id_token          String? @db.Text\n  session_state     String?\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n\n  @@unique([provider, providerAccountId])\n}\n\nmodel Session {\n  id           String   @id @default(cuid())\n  sessionToken String   @unique\n  userId       String\n  expires      DateTime\n\n  user User @relation(fields: [userId], references: [id], onDelete: Cascade)\n}\n\nmodel VerificationToken {\n  identifier String\n  token      String   @unique\n  expires    DateTime\n\n  @@unique([identifier, token])\n}\n\nmodel User {\n  id            String        @id @default(cuid())\n  name          String?\n  email         String?       @unique\n  image         String?\n  emailVerified DateTime?\n  accounts      Account[]\n  sessions      Session[]\n  jobs          Job[]         @relation(\"Posted Jobs\")\n  Application   Application[]\n}\n\nmodel Job {\n  id          String  @id @default(cuid())\n  title       String\n  company     String\n  location    String\n  description String  @db.Text\n  type        String\n  salary      String?\n\n  posted_at DateTime @default(now())\n  posted_by User     @relation(\"Posted Jobs\", fields: [posted_by_id], references: [id])\n\n  posted_by_id String\n\n  applications Application[]\n}\n\nmodel Application {\n  id         String   @id @default(cuid())\n  job_id     String\n  userId     String\n  status     String   @default(\"pending\")\n  applied_at DateTime @default(now())\n\n  user User @relation(fields: [userId], references: [id])\n  job  Job  @relation(fields: [job_id], references: [id])\n\n  @@unique([job_id, userId])\n}\n",
    "inlineSchemaHash": "cc2bfbb6f98ed1d249ce473bd464b1e99319596406930f11fc209214580aaf81",
    "copyEngine": true
};
...
const prisma = globalForPrisma.prisma || new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaClient"]().$extends((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$prisma$2f$extension$2d$accelerate$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAccelerate"])());
if ("TURBOPACK compile-time truthy", 1) globalForPrisma.prisma = prisma;
;
}}),
"[project]/app/api/jobs/[jobId]/apply/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    ...
    if (!session?.user || !session.user.id) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/auth/signin", request.url));
    try {
        ...
        if (!job) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("Job not found", {
                status: 404
            });
        }
        const existingApplication = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].application.findFirst({
            where: {
                job_id: job.id,
        ...
        if (existingApplication) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("You have already applied for this job", {
                status: 400
            });
        }
        const application = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].application.create({
            data: {
                job_id: job.id,
                userId: session.user.id,
                status: "PENDING"
...
//# sourceMappingURL=%5Broot-of-the-server%5D__08969231._.js.map